          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="kelola_barang">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{ url('/product') }}">Daftar Layanan</a>
                  </li>
                  <li class="nav-item">
        ...
        <div class="main-panel">
          ...
          <footer class="footer" id="footer-content">
            <div class="container-fluid clearfix">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © 2020 E-Laundry. All rights reserved.</span>
